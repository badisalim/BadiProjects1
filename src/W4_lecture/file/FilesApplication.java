...
public class FilesApplication {
    ...
    private static void readDocument(FileReader reader) {
        ...
        List<String> lines = reader.getLines("W4_lecture/file/document.txt");
    ...
    private static void readNames(FileReader reader) {
        ...
        List<String> lines = reader.getLines("W4_lecture/file/names.txt");
        for (String line : lines) {
    ...
    private static void readParticipants(FileReader reader) {
        ...
        List<String> lines = reader.getLines("W4_lecture/file/participants.csv");
