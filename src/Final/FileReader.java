...
public class FileReader {
    ...
    public List<String> asList(String filePath) {
        try {
            ...
            return (List<String>) Files.readAllLines(Paths.get("/home/badi/Downloads/BadiProjects/src/Final/buterfly-business.txt"));
    ...
    private Path getPath(String filePath) throws URISyntaxException {
        ...
        return Paths.get("/home/badi/Downloads/BadiProjects/src/Final/buterfly-business.txt");
    }
