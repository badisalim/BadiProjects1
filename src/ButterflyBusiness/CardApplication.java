...
public class CardApplication {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(number + " is " + (DiscoverCards.isValid(number) ? "Visa Electron valid" : "Visa Electron invalid"));

        System.out.println(number + " is " + (DiscoverCards.isValid(number) ? "Maestro valid" : "Maestro invalid"));

        System.out.println(number + " is " + (DiscoverCards.isValid(number) ? "InstaPayment valid" : "InstaPayment invalid"));
