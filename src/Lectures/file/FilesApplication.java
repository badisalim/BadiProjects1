...
public class FilesApplication {
    ...
    private static void readDocument(FileReader reader) {
        ...
        List<String> lines = reader.getLines("lecture/week4/file/document.txt");
    ...
    private static void readNames(FileReader reader) {
        ...
        List<String> lines = reader.getLines("lecture/week4/file/names.txt");
        for (String line : lines) {
    ...
    private static void readParticipants(FileReader reader) {
        ...
        List<String> lines = reader.getLines("lecture/week4/file/participants.csv");
